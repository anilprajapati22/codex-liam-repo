...
function showCodeInCard(){
  ...
  return(
    ...
    {/* for the 2nd page blob and input show */}
    {showtwobox? 
    ...
    {/* card 1 */}
      <div class="container d-flex justify-content-center align-items-center top-card">
          <div class="card">
              <div class="card-body">
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <button className="btn  btn-sm text-success fw-normal fs-6 ms-2 float-end ani"

                              onClick={showCodeInCard}>{ showcode & result.length >0 ?
          ...
          <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                  ...
                  sql_result[0].length === 1?
                    ...
                    <button class="btn  btn-sm fw-bold fw-normal fs-6 ms-0 float-end" >
                          
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cloud-download text-success mx-0" viewBox="0 0 16 16">
                  ...
                  :
                  <button class="btn  btn-sm fw-bold fw-normal fs-6 float-end" >
                  ...
                  >
                    <a href={"mailto:person@company.com?subject="+{query}+"&body="+{result} }>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-send text-success " viewBox="0 0 16 16">
              ...
              { is_run & showtable ?
                ...
                :<>{is_run?<>
                  ...
                  { isLoading_block2?<button class="btn btn fw-bold fw-normal fs-6 ms-1 ">
